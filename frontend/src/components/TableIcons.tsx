/** Iconos SVG para botones de acción en tablas. Tamaño 16px, color currentColor. MDI = Material Design Icons (Pictogrammers). */
const iconProps = { width: 16, height: 16, fill: 'currentColor' };
const iconProps24 = { ...iconProps, viewBox: '0 0 24 24' };

/** MDI: mdi/open-in-new (abrir enlace/URL, más reconocible que mdi/link) */
export function IconLink() {
  return (
    <svg {...iconProps24} aria-hidden>
...
const iconProps16 = { ...iconProps, viewBox: '0 0 16 16' };

export function IconEye() {
  return (
    <svg {...iconProps16} aria-hidden>
...
/** Icono refrescar/regenerar. MDI: mdi/refresh */
